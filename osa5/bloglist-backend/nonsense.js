...
console.log(authors)
const auhtorsUniq = lodash.uniq(authors)
console.log(auhtorsUniq)


//const authCount =
//const authCount = lodash.countBy(authors)
//console.log(authCount)
//console.log(Math.max(...Object.values(authCount)))
//const max = Math.max(...Object.values(authCount))
//console.log(Object.entries(authCount))
//const most = Object.entries(authCount).find(e => e[1] === max )
//console.log({ author: most[0], blogs: most[1] })
