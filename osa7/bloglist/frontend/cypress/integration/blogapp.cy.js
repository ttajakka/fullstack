describe('Blog app', function() {
  ...
  describe('When there exists several blogs', function() {
    ...
    it('those are ordered by the likes', function() {
      ...
      cy.get('@like2').click()
      cy.contains('blog3 author3').contains('likes 1')
      //cy.get('@like2').click()
      //cy.contains('blog3 author3').contains('likes 1')
      cy.get('@like2').click()
      cy.contains('blog3 author3').contains('likes 2')
      cy.get('@like2').click()
      cy.contains('blog3 author3').contains('likes 3')

      cy.get('@like1').click()
      cy.contains('blog2 author2').contains('likes 1')
      cy.get('@like1').click()
      cy.contains('blog2 author2').contains('likes 2')
